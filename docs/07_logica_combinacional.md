...
- __Suma__ . Es la operación que realiza la compuerta OR, esta se expresa como:  $f = a + b$
- __Producto__ . Es la operación de la compuerta AND, la cual se expresa como:  $f = ab$
- __Inversión__ . Es la operación que realiza la compuerta NOT. Se expresa como: $f = \overline{a}$
...
### El segundo teorema de DeMorgan
